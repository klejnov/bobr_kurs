...
function ideabank_by_27_id79($banks_id)
{
//header('Content-Type: text/html; charset=utf-8');
    ...
    curl_setopt($curl, CURLOPT_POSTFIELDS, "date=$databank&id=79");
    $json = curl_exec($curl);
    curl_close($curl);
    //print_r($json);
//$json = file_get_contents("json27_id79.txt");
    $arr = json_decode($json, true);

//echo "<H1>Идея Банк РКЦ №27 Адрес: ул. Минская, 54 В</H1>";
