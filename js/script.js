...
function infoMessage(banks_id, name, address, usd_buy, usd_sell, eur_buy, eur_sell, rub_buy, rub_sell) {
    ...
    swal.mixin({
        ...
        progressSteps: ['<i class="fontello-icon icon-dollar">&#xf155;</i>', '<i class="fontello-icon icon-euro">&#xf153;</i>', '<i class="fontello-icon icon-rouble">&#xf158;</i>']
    }).queue([
        {
            title: name,
            html:
            ...
            input: 'checkbox',
            inputValue: 0,
            inputPlaceholder: 'Подтверждаю, что курс<i class="fontello-icon icon-dollar">&#xf155;</i>ошибочный'
        },
        {
            title: name,
            html:
            ...
            input: 'checkbox',
            inputValue: 0,
            inputPlaceholder: 'Подтверждаю, что курс<i class="fontello-icon icon-euro">&#xf153;</i>ошибочный'
        },
        {
            title: name,
            html:
            ...
            input: 'checkbox',
            inputValue: 0,
            inputPlaceholder: 'Подтверждаю, что курс<i class="fontello-icon icon-rouble">&#xf158;</i>ошибочный'
        },
        {
