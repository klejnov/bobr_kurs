...
! function(e, t) {
    ...
    var a, n, s, c, u, d, l, f, p, g, h, m, v, b, y, w, I, _, C, j, S, T, L, E, O, A, x, P, D, k, Q, q, U, N, G, R, K, H, M, V, z, B, X, J, Y = (n = "ajaxLoad", s = "coreui.ajaxLoad", c = (a = t).fn[n], u = "active", d = "open", l = "view-script", f = "click", p = ".sidebar-nav .nav-dropdown", g = ".sidebar-nav .nav-link", h = ".sidebar-nav .nav-item", m = ".view-script", v = {
            ...
            return e.loadPage = function(r) {
                ...
                a.ajax({
                    ...
                    success: function(e) {
                        ...
                        t.querySelectorAll("script").forEach(function(e) {
                            ...
                            scrollTop: 0
                        }, 0), a(o).html(t), n.length && function e(t, n) {
                            void 0 === n && (n = 0);
                ...
                a(g).removeClass(u), a(p).removeClass(d), a(p + ':has(a[href="' + e.replace(/^\//, "").split("?")[0] + '"])').addClass(d), a(h + ' a[href="' + e.replace(/^\//, "").split("?")[0] + '"]').addClass(u), this.loadPage(e)
                ...
                var t = this;
                a(document).on(f, g + '[href!="#"]', function(e) {
                ...
                return this.each(function() {
                    var e = a(this).data(s);
                    e || (e = new n(this, "object" == typeof t && t), a(this).data(s, e))
                })
            }, i(n, null, [{
                key: "VERSION",
                get: function() {
        ...
        }(), a.fn[n] = b._jQueryInterface, a.fn[n].Constructor = b, a.fn[n].noConflict = function() {
            return a.fn[n] = c, b._jQueryInterface
        }, b),
        $ = function(e, t) {
            var n = t.indexOf(e),
