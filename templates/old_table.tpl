    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="show-view">
                    <span>Перейти в</span>
                    <button type="button" class="btn btn-outline-secondary show-new">новый</button>
                    <span>вид</span>
                </div>
            </div>
        </div>
...
<script src="../js/old_table.js"></script>
